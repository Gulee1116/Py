...
class Ui_MainWindow(QtWidgets.QDialog):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(
            _translate("MainWindow", "    1.添加文件：你可以把你的画拖进来，或者点击下面的添加文件")
        )
        self.pushButton.setText(_translate("MainWindow", "添加文件"))
        self.pushButton.clicked.connect(lambda: self.add_text("还没做"))  # type: ignore
        ...
        self.pushButton_2.clicked.connect(lambda: self.add_text(f"还没做，不过知道是{self.lineEdit.text()}"))  # type: ignore
