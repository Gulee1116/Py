...
# 截屏攻击
att.cut_att3(
    input_filename="output/embedded.png",
    output_file_name="output/截屏攻击1.png",
    loc=(x1, y1, x2, y2),
    scale=scale,
)

recover_crop(
    template_file="output/截屏攻击1.png",
    output_file_name="output/截屏攻击1_还原.png",
    loc=(x1, y1, x2, y2),
...
att.cut_att3(
    input_filename="output/embedded.png",
    output_file_name="output/截屏攻击2.png",
    loc=(x1, y1, x2, y2),
    scale=scale,
)
...
print(
    f"Crop att estimate parameters: x1={x1},y1={y1},x2={x2},y2={y2}, scale_infer = {scale_infer}. score={score}"
)
...
att.cut_att3(
    input_filename="output/embedded.png",
    output_file_name="output/随机裁剪攻击.png",
    loc=(x1, y1, x2, y2),
    scale=None,
)
...
recover_crop(
    ...
    output_file_name="output/随机裁剪攻击_还原.png",
    loc=(x1, y1, x2, y2),
    image_o_shape=image_o_shape,
)
...
att.cut_att3(
    input_filename="output/embedded.png",
    output_file_name="output/随机裁剪攻击2.png",
    loc=(x1, y1, x2, y2),
    scale=None,
)
...
print(
    f"Cut attack's estimate parameters: x1={x1},y1={y1},x2={x2},y2={y2}. score={score}"
)

# recover from attack:
recover_crop(
    template_file="output/随机裁剪攻击2.png",
    output_file_name="output/随机裁剪攻击2_还原.png",
    loc=(x1, y1, x2, y2),
    image_o_shape=image_o_shape,
)
...
att.rot_att(
    input_filename="output/旋转攻击.png",
...
att.shelter_att(
    input_filename="output/embedded.png",
    output_file_name="output/多遮挡攻击.png",
    ratio=0.1,
    n=n,
)
...
att.resize_att(
    input_filename="output/缩放攻击.png",
...
att.bright_att(
    input_filename="output/embedded.png", output_file_name="output/亮度攻击.png", ratio=0.9
)
att.bright_att(
    input_filename="output/亮度攻击.png", output_file_name="output/亮度攻击_还原.png", ratio=1.1
)
